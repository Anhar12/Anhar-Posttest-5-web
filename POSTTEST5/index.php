        ...
        <div class="produk">
            ...
            <div class="baris1">
                <div class="kolom">
                    ...
                    <p class="merk"> Samsung Galaxy A71 </p>
                </div>
                <div class="kolom">
                    ...
                    <p class="merk"> Apple iPhone 14 Pro Max </p>
                </div>
                <div class="kolom">
                    ...
                    <p class="merk"> Vivo V25 Pro Max </p>
                </div>
            </div>
            <div class="baris2">
                <div class="kolom">
                    ...
                    <p class="merk"> Realme GT Neo 3T </p>
                </div>
                <div class="kolom">
                ...
                <div class="kolom">
                    ...
                    <p class="merk"> Xiaomi Poco X4 Pro 5G </p>
                </div>
            </div>
        </div>
